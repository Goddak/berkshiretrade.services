...
const BathroomFitting: Service = {
	...
	longDesc: `Your bathroom is more than just a functional space; it's your personal sanctuary, a place of relaxation and rejuvenation. Our bathroom fitting services are dedicated to creating a bathroom that not only meets your practical needs but also provides a luxurious retreat within your home.
							...
							Imagine stepping into a bathroom designed exclusively for you, with custom fixtures, beautiful tiles, and a layout that maximizes space and comfort. Whether you desire a spa-like oasis for unwinding after a long day or a sleek, modern bathroom that impresses guests, we are here to bring your vision to life.

							Our team of skilled craftsmen takes a meticulous approach to bathroom fitting. We understand that your bathroom should reflect your style and personality while serving as a functional space for your daily routines. From the initial design to the final details, we collaborate closely with you to ensure that your preferences and practical requirements are met.

							We are committed to using high-quality materials and innovative construction techniques to ensure the longevity and durability of your new bathroom. Our goal is to create a space that not only looks stunning but also withstands the test of time.

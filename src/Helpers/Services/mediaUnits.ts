...
const MediaUnits: Service = {
	...
	longDesc: `In today's modern homes, the media unit has become a focal point, where technology and style harmonize to create a functional and aesthetic centerpiece. At our company, we specialize in crafting bespoke media units that not only accommodate your entertainment essentials but also elevate the overall look and feel of your living space.
							...
							Our media unit services are designed to transform your TV and multimedia area into a seamless blend of form and function. Imagine a custom-designed media unit perfectly tailored to your room's dimensions and your unique style preferences. It's more than just a place to house your television; it's a statement piece that complements your interior design.

							Our experienced craftsmen take a personalized approach to media unit creation, working closely with you to understand your vision. Whether you prefer a sleek, minimalist design or a more traditional, ornate piece, we have the expertise to bring your ideas to life. We consider cable management, storage solutions, and ergonomic design to ensure that your media unit is not only visually stunning but also highly practical.

							We are committed to using top-quality materials, ensuring that your media unit stands the test of time. From solid wood finishes to modern high-gloss surfaces, our range of options allows you to customize every detail to your liking.

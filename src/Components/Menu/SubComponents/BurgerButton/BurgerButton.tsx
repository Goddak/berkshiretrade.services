...
const BurgerButton: React.FC<IBurgerButton> = ({ isOpen, onClick }) => {
	return <button onClick={onClick} className={`w-10 h-10 flex flex-col justify-around items-center focus:outline-none`}
		aria-label="Menu">
